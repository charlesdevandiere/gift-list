...
-- AddForeignKey
ALTER TABLE "Gift" ADD CONSTRAINT "Gift_offeredByUserId_fkey" FOREIGN KEY ("offeredByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
